...
This repository maintains a time- and space-efficient implementation of the BDA-index, a text index introduced by [Loukides, Pissis, and Sweering](https://doi.org/10.1109/TKDE.2022.3231780).
